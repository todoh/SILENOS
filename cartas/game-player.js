...
const PlayerBoard = ({ player, isMyTurn, phase, playCard, useAbility, advancePhase, incomingStack, assignDefender, onInspect, autoDefend }) => {
    ...
    // Soltar sobre el CAMPO (Jugar carta)
    ...
    // Soltar sobre un ATAQUE (Defender)
    ...
    const handleTouchEnd = (e) => {
        ...
        // Soltar Carta de MANO en el CAMPO
        ...
        // Soltar Unidad de CAMPO en un ATAQUE
    ...
    return (
        <div className="flex-1 flex flex-col justify-end relative w-full overflow-hidden bg-[var(--bg-main)]">
            ...
            {/* ELEMENTO FLOTANTE AL ARRASTRAR (TOUCH) */}
            ...
            <div className="flex-1 overflow-y-auto flex flex-col justify-center gap-2 pb-2">
                ...
                {isMyTurn && phase === 'response' && incomingStack.length > 0 && (
                    <div className="neo-inset mx-2 my-2 p-2 flex flex-col border border-red-500/20">
                        {/* Cabecera de Defensa con Botón Auto */}
                ...
                {/* CAMPO PROPIO - ZONA DE DROP PARA JUGAR CARTAS */}
                <div 
                    ...
                    className={`
                        ...
                        ${(dragState && dragState.type === 'hand') ? 'bg-green-500/10 border-t-2 border-green-400/50 shadow-[inset_0_0_20px_rgba(74,222,128,0.2)]' : ''}
                    `}
                >
                     <div className="flex gap-4 px-4 min-w-max justify-center items-start h-full">
                        ...
                        {player.field.map((unit, idx) => {
                            const showActions = isMyTurn && phase === 'main' && !unit.isFrozen;
                ...
                <div className="w-full overflow-x-auto no-scrollbar p-3">
                    <div className="flex gap-2 px-2 min-w-max justify-center">
                        ...
                        {player.hand.map((card, idx) => {
                            const canDrag = isMyTurn && phase === 'main' && player.energy >= card.cost;
                            ...
                            return (
                                ...
                                >
                                    ...
                                    />
                                    {/* Indicador de coste visual rápido */}
