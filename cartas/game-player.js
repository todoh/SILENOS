...
const PlayerBoard = ({ player, isMyTurn, phase, playCard, useAbility, advancePhase, incomingStack, assignDefender, onInspect, autoDefend, isTargeting, onCardClick }) => { // 1. DECLARACIÓN DEL ESTADO (IMPORTANTE: No borrar) const [dragState, setDragState] = React.useState(null);
