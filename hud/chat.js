...
export function manageChatWindows(activeTabs, allUsers, myRealId) {     
    // Eliminar ventanas que ya no est n activas     
    ...
    for (let targetId in activeTabs) {         
        ...
        if (!win) {             
            ...
            // Limpiar flag de notificaci n al hacer click dentro de su input o ventana             
...
// Inicializaci n de eventos interactivos sobre el contenedor de ventanas y barra inferior 
