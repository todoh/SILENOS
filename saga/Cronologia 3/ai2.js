...
const ai2 = {
    ...
    async calculateStructure() {
        ...
        try {
            ...
            // Análisis profundo de texto y conteo estructural requiere gran capacidad -> gemini-fast
            const auditRes = await ai.callModel(auditPrompt, "Audita la historia y dame el número REAL de capítulos necesarios.", 0.2, 'gemini-fast');
